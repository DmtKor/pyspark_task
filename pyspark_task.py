...
def get_test_dataframes(spark: SparkSession) -> Tuple[DataFrame, DataFrame, DataFrame]:
...
# The desired method
def get_pairs(spark: SparkSession, products_df: DataFrame, categories_df: DataFrame, links_df: DataFrame) -> Tuple[DataFrame, DataFrame]:
    """
    Parameters:
...
if __name__ == "__main__":
    ...
    pr_df, cat_df, links_df = get_test_dataframes(spark)
    prod_cat_df, prod_without_cat_df = get_pairs(spark, pr_df, cat_df, links_df)
